...
<div class="nav-left">
<a href="index.html" class="title">Yuri Lavinas' Research Page</a>
...
\begin{center}\includegraphics[width=0.6\linewidth]{gifs/Visualization_of_a_population_evolving_in_a_static_fitness_landscape} \end{center}
...
\begin{center}\includegraphics{gifs/new_is_always_better_gif} \end{center}
...
\begin{center}\includegraphics[width=0.4\linewidth]{gifs/cool_peralta} \end{center}
