...
![Example of real output of a game where one player is controlled by an Artificial NeuralNetwork using the Proximal Policy Optimization[^1]](imgs/2D_representation_video.png)
...
3. With the **University of Norwegian University of Science and Technology**, with Prof. Ricardo Torres, **Londrina State University**, with Prof. Felipe Moura and **University of Campinas**, with Prof. Sergio Moura.
